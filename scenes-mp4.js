const CONFIG = {
  ...
  scenes: {
    aereo:   { video: { mp4: "images/1.mp4",      webm: "images/1.webm" },      pois: [] },
    pool:    { video: { mp4: "images/3.mp4",      webm: "images/3.webm" },      pois: [] },
    living:  { video: { mp4: "images/l_loop.mp4", webm: "images/l_loop.webm" }, pois: [] },
    jardim:  { video: { mp4: "images/j_loop.mp4", webm: "images/j_loop.webm" }, pois: [] },
    kitchen: { video: { mp4: "images/k_loop.mp4", webm: "images/k_loop.webm" }, pois: [] },
  },

  sequences: {
    "aereo-to-pool": {
      folder: "images/seq_arch/", prefix: "aereo_to_piscina_",
      from: 0, to: 47, pad: 2, ext: "jpg", fps: 30,
    },
    "pool-to-aereo": {
      folder: "images/seq_arch/", prefix: "aereo_to_piscina_",
      from: 0, to: 47, pad: 2, ext: "jpg", reverse: true,
    },
    "pool-to-living": {
    ...
    "living-to-pool": {
      folder: "images/seq_arch/", prefix: "pool_to_living_",
      from: 0, to: 72, pad: 2, ext: "jpg", reverse: true,
    },
    "pool-to-kitchen": {
